...
PAIRS = [
    ("Plants make food using sunlight, water, and carbon dioxide.", "Plants create their own food with light, water and CO2."),
    ("The water cycle includes evaporation, condensation, and precipitation.", "Water evaporates, forms clouds, and then falls as rain."),
    ("A fraction shows a part of a whole, like 1/2 of a pizza.", "Fractions represent pieces of something, like half a pizza."),
    ("Python lists can store many values in one variable.", "A list in Python keeps multiple items together in one place."),
    ("Rome is the capital of Italy and it has many ancient buildings.", "Italy's capital is Rome, famous for old historical monuments."),
    ("I love summer because I can play outside for longer.", "Summer is my favorite since I get extra time to play outdoors.")
]
...
def verdict(score01: float, threshold: float) -> str:
    if score01 >= threshold:
        return "⚠%EF%B8%8F TOO SIMILAR (possible copy)"
